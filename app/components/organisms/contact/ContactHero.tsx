...
export const ContactHero = () => {
  ...
  return (
    <section className="relative w-full h-87.5 sm:h-105 lg:h-120">
      ...
      <iframe
        src={MAPS_EMBED_URL}
        className={`absolute inset-0 w-full h-full border-0 grayscale-[0.3] invert brightness-90 contrast-105 transition-opacity duration-500 ${loaded ? 'opacity-100' : 'opacity-0'}`}
        allowFullScreen
        loading="lazy"
