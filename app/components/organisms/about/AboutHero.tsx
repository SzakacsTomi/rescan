...
export const AboutHero = ({ eyebrow, headline, subheadline, facts, image }: AboutHeroProps) => {
  return (
    <section className="relative overflow-hidden bg-[#E5EAF5]">
      <div aria-hidden className="absolute inset-0" style={{ backgroundImage: PAPER_RULING, backgroundSize: PAPER_RULING_SIZE }} />
      <div aria-hidden className="absolute inset-0" style={{ background: TITLE_BLOCK_GLOW }} />

      <div className="relative w-full max-w-480 mx-auto px-6 pt-16 sm:pt-20 lg:pl-[126px] lg:pt-29">
        <div className="grid max-w-310 grid-cols-1 items-end gap-12 pb-16 lg:grid-cols-[minmax(0,1fr)_300px] lg:gap-20">
          <div>
        ...
        <MediaPlaceholder
          stripe={HERO_IMAGE_STRIPE}
          className="h-[340px] border-t border-foreground/12"
        >
